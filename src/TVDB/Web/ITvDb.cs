...
namespace TVDB.Web
{
    ...
    public interface ITvDb
    {
        ...
        Task<SeriesDetails?> GetFullSeriesByIdAsync(int id, string languageAbbreviation, Mirror? mirror);
        ...
        /// <param name="mirror">The mirror to use.</param>
        /// <returns>All details of the series.</returns>
        Task<SeriesDetails?> GetFullSeriesByIdAsync(int id, Mirror? mirror);
        ...
        /// <returns>Collection of all available languages.</returns>
        Task<IList<Language>?> GetLanguagesAsync(Mirror? mirror);
        ...
        Task<IList<Mirror>> GetMirrorsAsync();
        ...
        Task<IList<Series>?> GetSeriesByNameAsync(string name, string languageAbbreviation, Mirror mirror);
        ...
        /// </remarks>
        /// <returns>List of series that matches the provided name.</returns>
        Task<IList<Series>?> GetSeriesByNameAsync(string name, Mirror? mirror);
        ...
        /// </remarks>
        Task<IList<Series>?> GetSeriesByRemoteIdAsync(string imdbId, string zap2Id, string languageAbbreviation, Mirror mirror);
        ...
        /// It is not allowed to provide both imdb and zap2it id, this will lead to a null value as return value.
        /// </remarks>
        Task<IList<Series>?> GetSeriesByRemoteIdAsync(string imdbId, string zap2Id, Mirror mirror);
    }
}
